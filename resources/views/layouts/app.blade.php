...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color: rgba(122, 131, 124, 1)">
            <div class="container">
...
{{--                        <a class="item" href="{{ route('register') }}">Зарегистрироваться</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
