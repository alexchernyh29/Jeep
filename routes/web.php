...
Route::get('/home/edit', [App\Http\Controllers\HomeController::class, 'index'])->name('home.edit');
Route::get('/user', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
Route::get('user/edit/{id}', [\App\Http\Controllers\HomeController::class, 'edit'])->name('home.edit');
Route::post('user/update', [\App\Http\Controllers\AppController::class, 'update'])->name('user.update');
